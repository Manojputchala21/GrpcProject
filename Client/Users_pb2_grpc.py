...
class UserOperationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendData = channel.unary_unary(
                '/users.UserOperation/SendData',
                request_serializer=Users__pb2.SendDataToServer.SerializeToString,
                response_deserializer=Users__pb2.GetUserResponse.FromString,
                _registered_method=True)


class UserOperationServicer(object):
    """The greeting service definition.
    """
...
def add_UserOperationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendData': grpc.unary_unary_rpc_method_handler(
                    servicer.SendData,
                    request_deserializer=Users__pb2.SendDataToServer.FromString,
                    response_serializer=Users__pb2.GetUserResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'users.UserOperation', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('users.UserOperation', rpc_method_handlers)
...
class UserOperation(object):
    ...
    def SendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/users.UserOperation/SendData',
            Users__pb2.SendDataToServer.SerializeToString,
            Users__pb2.GetUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
